...
static const char *g_szDesc      = "PlugA模块，和PlugB模块协同工作";       //模块的描述文字
static const char *g_szName      = "PlugA模块";                            //模块的名字
static const char *g_szModuleKey = "PlugA";                                //模块的Key
